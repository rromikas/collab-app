  ...
  return (
    <div className="container-fluid h-100 d-flex flex-column">
      <div className="row flex-shrink-0">
        <div className="col-12 border">Navbar </div>
      </div>
      <div className="row flex-fill" style={{ minHeight: 0 }}>
        <div className="col-2 border mh-100" style={{ overflowY: "scroll" }}>
          Sidebar{" "}
        </div>
        <div className="col-4 border mh-100" style={{ overflowY: "scroll" }}>
          <div className="row">
            Article list
            <p>
        ...
        <div className="col-6 border" style={{ overflowY: "scroll" }}>
          Article content{" "}
        </div>
      </div>
      <div className="row flex-shrink-0">
